...
<head>
    ...
    <meta name="keywords"
          content=" کانون تبلیغات و آگهی پیام رهپاد , کانون تبلیغاتی , تبلیغات , تبلیغ , طراحی سایت, SEO , تولید نرم افزار , طراحی لوگو , طراحی سربرگ , طراحی کاتالوگ , برگزاری همایش , انتشار آگهی نامه , ساختمان , صنعت ساختمان , آگهی نامه صنعت ساختمان , آگهی نامه کاربردهای اداری فناوری اطلاعات و ارتباطات , گروه رهپاد ,  مدیریت شهری ,  خدمات شهری ,  Rahpad Group"/>
    <meta name="description"
          content=" ارائه دهنده کلیه خدمات انتشار آگهی نامه های تخصصی در حوزه های فناوری اطلاعات، عمران، مدیریت شهری و ..."/>
    <meta name="viewport"
          content="width=330px, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    @extends('Layouts.headerCssFiles')
    <style type="text/css">
        .carousel-caption {
            top: 82%;
            right: 0;
        ...
        <div class="dropdown" style="position: absolute;right: 20px;top:30px;">
            ...
            <ul class="dropdown-menu dropdown-toggle" aria-labelledby="dropdownMenu1"
                ...
                @if(\App\Http\Controllers\PermissionController::This_is_Admin_or_ContentManager())
                    <li role="separator" class="divider"></li>
                    <li style="text-align: center"><a href="{{route('uppass')}}"><span class="glyphicon glyphicon-lock"> تغییر-رمز-عبور </span></a>
                    </li>
                    <li role="separator" class="divider"></li>
                    @if(Auth::guard('admin')->check())
                    ...
                    <li style="text-align: center;"><a href="{{route('message.page')}}"><span> پیام <span
                                        class="badge">{{\App\Http\Controllers\AjaxMessageController::Count_unread_admin_messages()}}</span></span></a>
                    </li>
                    <li role="separator" class="divider"></li>
                ...
                @else
                    <li role="separator" class="divider"></li>
                    <li style="text-align: center"><a href="{{route('update')}}"><span class="glyphicon glyphicon-edit"> ویرایش </span></a>
                    </li>
                    <li role="separator" class="divider"></li>
                    <li style="text-align: center"><a href="{{route('uppass')}}"><span class="glyphicon glyphicon-lock"> تغییر-رمز-عبور </span></a>
                    </li>

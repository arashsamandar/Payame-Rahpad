        ...
        <div class="modal-content" style="padding: 50px;">
            ...
            <form method="post" action="{{route('changeUserPassword')}}" id="changepass">
                <div class="row">
                    ...
                    <div class="col-xs-6 col-md-6 col-md-6">
                        <div class="form-group">
                            <input tabindex="9" id="password" type="password" maxlength="60" name="password" value="{{old('password')}}" class="form-control input-md" placeholder="password">
                    ...
                    <div class="col-xs-6 col-md-6 col-md-6">
                        <div class="form-group">
                            <input tabindex="10" id="passconf" maxlength="60" type="password" name="password_confirmationn" class="form-control input-md" placeholder="confirm password">
                ...
                <div class="row modal-footer">
                    <div class="col-md-3">
                        <div class="form-group">
                            <input type="button" value="Back" onclick="closepass()" data-dismiss="modal" class="btn btn-danger btn-block"  />
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">

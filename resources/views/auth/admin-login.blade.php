...
<form role="form" class="form-horizontal" method="POST" action="{{ route('admin.login.submit') }}">
    ...
    <div class="input-group" dir="rtl"> <span class="input-group-addon"> <i class="zmdi zmdi-account"></i> </span>
        <div class="form-line">
    ...
    <div class="input-group" dir="rtl"> <span class="input-group-addon"> <i class="zmdi zmdi-lock"></i> </span>
        <div class="form-line">
